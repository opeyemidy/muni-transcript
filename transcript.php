...
if(isset($_GET['s_id']) && !empty($_GET['s_id'])) {
  ...
  if (mysqli_num_rows($student_details) >
0) { $student_data = mysqli_fetch_array($student_details); } else {
    ...
    <div class="wrapper">
      ...
      <div class="student-info">
        ...
        <div>
          ...
          <h3>(left)</h3>
          <div class="field"><?php echo $student_data['year_graduated']?></div>
        </div>
        <div>
          <h3>faculty</h3>
      ...
      <!-- 100l first semester -->
      <?php
        $sqlSelect_1_1 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 100 AND course_semester = 1";
        $result_1_1 = mysqli_query($conn, $sqlSelect_1_1);

        if (mysqli_num_rows($result_1_1) >
      0) { $row_1_1 = mysqli_fetch_array($result_1_1); ?>
      <div class="result-wrapper">
        <table class="result-table">
          <thead>
            ...
            <tr>
              <th>course code</th>
              <th style="text-align: left; padding-left: 5px">course title</th>
              <th>credit unit</th>
              <th>letter grade</th>
              <th>grade point</th>
          ...
          <tbody>
            <?php
              $result_query_1_1 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 100 AND course_semester = 1";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_1_1['course_title']?></td>
      ...
      <?php
        $sqlSelect_1_2 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 100 AND course_semester = 2";
        $result_1_2 = mysqli_query($conn, $sqlSelect_1_2);

        if (mysqli_num_rows($result_1_2) >
      0) { $row_1_2 = mysqli_fetch_array($result_1_2); ?>
      <div class="result-wrapper">
        <table class="result-table">
          <thead>
            <tr>
          ...
          <tbody>
            <?php
              $result_query_1_2 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 100 AND course_semester = 2";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_1_2['course_title']?></td>
      ...
      <!-- 200L first semester -->
      <?php
        $sqlSelect_2_1 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 200 AND course_semester = 1";
        $result_2_1 = mysqli_query($conn, $sqlSelect_2_1);

        if (mysqli_num_rows($result_2_1) >
      0) { $row_2_1 = mysqli_fetch_array($result_2_1); ?>
      <div class="result-wrapper">
        <table class="result-table">
          <thead>
            <tr>
          ...
          <tbody>
            <?php
              $result_query_2_1 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 200 AND course_semester = 1";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_2_1['course_title']?></td>
      ...
      <?php
        $sqlSelect_2_2 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 200 AND course_semester = 2";
        $result_2_2 = mysqli_query($conn, $sqlSelect_2_2);

        if (mysqli_num_rows($result_2_2) >
      0) { $row_2_2 = mysqli_fetch_array($result_2_2); ?>
      <div class="result-wrapper">
        <table class="result-table">
          <thead>
            <tr>
          ...
          <tbody>
            <?php
              $result_query_2_2 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 200 AND course_semester = 2";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_2_2['course_title']?></td>
      ...
      <!-- 300L first semester -->
      <?php
        $sqlSelect_3_1 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 300 AND course_semester = 1";
        $result_3_1 = mysqli_query($conn, $sqlSelect_3_1);

        if (mysqli_num_rows($result_3_1) >
      0) { $row_3_1 = mysqli_fetch_array($result_3_1); ?>
      <div class="result-wrapper">
        <table class="result-table">
          <thead>
            <tr>
          ...
          <tbody>
            <?php
              $result_query_3_1 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 300 AND course_semester = 1";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_3_1['course_title']?></td>
      ...
      <?php
        $sqlSelect_3_2 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 300 AND course_semester = 2";
        $result_3_2 = mysqli_query($conn, $sqlSelect_3_2);

        if (mysqli_num_rows($result_3_2) >
      0) { $row_3_2 = mysqli_fetch_array($result_3_2); ?>
      <div class="result-wrapper">
        <table class="result-table">
          <thead>
            <tr>
          ...
          <tbody>
            <?php
              $result_query_3_2 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 300 AND course_semester = 1";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_3_2['course_title']?></td>
      ...
      <!-- 400L first semester -->
      <?php
        $sqlSelect_4_1 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 400 AND course_semester = 1";
      ...
      <div class="result-wrapper">
        <table class="result-table">
          ...
          <tbody>
            <?php
              $result_query_4_1 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 400 AND course_semester = 1";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_4_1['course_title']?></td>
      ...
      <?php
        $sqlSelect_4_2 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 400 AND course_semester = 2";
      ...
      <div class="result-wrapper">
        <table class="result-table">
          ...
          <tbody>
            <?php
              $result_query_4_2 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 400 AND course_semester = 2";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_4_2['course_title']?></td>
      ...
      <!-- 500L first semester -->
      <?php
        $sqlSelect_5_1 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 500 AND course_semester = 1";
      ...
      <div class="result-wrapper">
        <table class="result-table">
          ...
          <tbody>
            <?php
              $result_query_5_1 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 400 AND course_semester = 2";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_5_1['course_title']?></td>
      ...
      <?php
        $sqlSelect_5_2 = "SELECT `course_level`,`course_semester` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 500 AND course_semester = 2";
      ...
      <div class="result-wrapper">
        <table class="result-table">
          ...
          <tbody>
            <?php
              $result_query_5_2 = "SELECT `course_code`,`course_title`,`credit_unit`,`grade`,`grade_point` FROM `grade` WHERE student_id = '$the_student_id' AND course_level = 400 AND course_semester = 2";
            ...
            <tr>
              ...
              <td style="text-align: left; padding-left: 5px"><?php echo $grade_row_5_2['course_title']?></td>
